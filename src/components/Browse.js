...
const Browse = () => {
  return (
    <div className="bg-gray-100">
      {/* Full-Page Image with Heading and Button */}
      <div className="relative h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${image1})` }}>
        <div className="absolute top-1/2 left-3/4 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 shadow-text">Get Started Predicting Your Yield</h1>
          <Link to="/some-page" className="inline-block px-8 py-3 text-lg bg-blue-600 hover:bg-blue-700 text-white rounded-full transition duration-300 shadow-lg hover:shadow-xl">
            Get Started
          </Link>
        </div>
      </div>
      ...
      {/* Second Image */}
      <div className="h-96 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${image2})` }}></div>

      {/* Second Text Section */}
      <div className="max-w-4xl mx-auto my-16 px-4 text-center">
        <h2 className="text-3xl font-bold mb-4 text-gray-800">Continuous Help to the Farmers</h2>
        <p className="text-xl text-gray-600 leading-relaxed">
          Helping farmers by analyzing soil health, providing weather forecasts, predicting crop impact, and offering guidance on planting, harvesting, and pest control to improve crop yield and sustainability.
        </p>
      </div>
      ...
      {/* Third Image */}
      <div className="h-96 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${image3})` }}></div>

      {/* Third Text Section */}
      <div className="max-w-4xl mx-auto my-16 px-4 text-center">
        <h2 className="text-3xl font-bold mb-4 text-gray-800">Farmers Can Sell Their Products</h2>
        <p className="text-xl text-gray-600 leading-relaxed">
          Farmers can list and sell their crops directly through our platform, allowing customers to purchase fresh, locally-grown produce with ease. Enjoy quality farm-fresh goods delivered straight to your table.
        </p>
      </div>
      ...
      {/* Fourth Image */}
      <div className="h-96 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${image4})` }}></div>
    </div>
  );
};
